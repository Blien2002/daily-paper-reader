...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-15 22:28:21 UTC<br>状态：成功</p>
</section>
...
<p>今日共生成 28 篇推荐（精读 16 篇，速读 12 篇）</p>
<p>精读：《ObstaDiff: Generalizable Diffusion Policy Learning via Obstacle-aware Representations》（9.0/10）, 《2AM: Grounding Agent-Side Memory as Guidance for Steerable Action Models in Long-Horizon Manipulation》（9.0/10）</p>
<p>速读：《ReactHuman: A Physics-Grounded Benchmark for Human-Like Reactive Decision-Making in Embodied Multimodal LLMs》（8.0/10）, 《Improving Imitation Learning Efficiency for Manipulation through Geometric Prior Pretraining》（8.0/10）, 《STAGE: Diagnosing Semantic Transfer at Grounded Execution in Embodied Agents》（8.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="ObstaDiff: Generalizable Diffusion Policy Learning via Obstacle-aware Representations">ObstaDiff: Generalizable Diffusion Policy Learning via Obstacle-aware Representations</span></li><li><span class="dpr-home-dashboard-paper-title" title="2AM: Grounding Agent-Side Memory as Guidance for Steerable Action Models in Long-Horizon Manipulation">2AM: Grounding Agent-Side Memory as Guidance for Steerable Action Models in Long-Horizon Manipulation</span></li><li><span class="dpr-home-dashboard-paper-title" title="MoPA: Coordinated Mobile Manipulation via Subsystem-Specific Perception Alignment">MoPA: Coordinated Mobile Manipulation via Subsystem-Specific Perception Alignment</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">vla <strong>11</strong></span><span class="dpr-home-dashboard-tag">tf <strong>5</strong></span></div>
</section>
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="ReactHuman: A Physics-Grounded Benchmark for Human-Like Reactive Decision-Making in Embodied Multimodal LLMs">ReactHuman: A Physics-Grounded Benchmark for Human-Like Reactive Decision-Making in Embodied Multimodal LLMs</span></li><li><span class="dpr-home-dashboard-paper-title" title="Improving Imitation Learning Efficiency for Manipulation through Geometric Prior Pretraining">Improving Imitation Learning Efficiency for Manipulation through Geometric Prior Pretraining</span></li><li><span class="dpr-home-dashboard-paper-title" title="STAGE: Diagnosing Semantic Transfer at Grounded Execution in Embodied Agents">STAGE: Diagnosing Semantic Transfer at Grounded Execution in Embodied Agents</span></li></ul>
  </div>
