...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-10 21:46:14 UTC<br>状态：成功</p>
</section>
...
<p>精读：《WM-Craftnet: World Synesthesia Model for Generalizable and Robust Dexterous In-Hand Manipulation》（8.0/10）, 《BIFTA: Brain-Inspired Few-Shot Tactile Adaptation for Unknown Sensors》（8.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="WM-Craftnet: World Synesthesia Model for Generalizable and Robust Dexterous In-Hand Manipulation">WM-Craftnet: World Synesthesia Model for Generalizable and Robust Dexterous In-Hand Manipulation</span></li><li><span class="dpr-home-dashboard-paper-title" title="BIFTA: Brain-Inspired Few-Shot Tactile Adaptation for Unknown Sensors">BIFTA: Brain-Inspired Few-Shot Tactile Adaptation for Unknown Sensors</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">tf <strong>2</strong></span></div>
</section>
